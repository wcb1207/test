...
import com.fumei.pdfread.MyActivity;
...
public class ReaderView
	...
	private static final int  GAP               = 0;//页面间的间隙
	...
	public void setDisplayedViewIndex(int i) {
		if (0 <= i && i < mAdapter.getCount()) {
			...
			mResetLayout = true;
			//add by runbao
			Log.i("file", "ReaderView setDisplayedViewIndex");
			requestLayout();
		}
	}
	...
	public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
		...
		if (v != null) {
			...
			case MOVING_LEFT:
				...
				break;
			case MOVING_UP:
				Log.i("file","ReaderView onFling MOVING_UP");
	...
	public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX,
		...
		if (!mScaling) {
			...
			//add by runbao
			Log.i("file", "ReaderView onScroll");
			requestLayout();
			//����  measure(); measureView()
		}
		return true;
	...
	public boolean onScale(ScaleGestureDetector detector) {
		...
		if (mReflow) {
			...
			if (v != null) {
				...
				//add by runbao
				Log.i("file", "ReaderView onScale(ScaleGestureDetector detector) ");
				requestLayout();
			}
		}
		return true;
	...
	public void onScaleEnd(ScaleGestureDetector detector) {
		...
		mScaling = false;
		//add by runbao
		Log.i("file", "onScaleEnd  mScale"+mScale);//5.0
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		//add by runbao
		Log.i("file", "ReaderView onTouchEvent");
		requestLayout();
		return true;
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		try {
			...
			if (!memAlert) {
				memAlert = true;
				AlertDialog alertDialog = MyActivity.getAlertBuilder().create();
	...
	public void setAdapter(Adapter adapter) {
		...
		mAdapter = adapter;
		//add by runbao
				Log.i("file", "ReaderView setAdapter");
		requestLayout();
	}
	...
	private void measureView(View v) {
		...
		//add by runbao
		Log.i("file", "ReaderView measureView ");
	}
	...
	private Rect getScrollBounds(View v) {
		//add by runbao
				Log.i("file", "ReaderView getScrollBounds ");
